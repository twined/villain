(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("Villain", [], factory);
	else if(typeof exports === 'object')
		exports["Villain"] = factory();
	else
		root["Villain"] = factory();
})(this, function() {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__plus__ = __webpack_require__(11);
...
var Block = __WEBPACK_IMPORTED_MODULE_1_backbone___default.a.View.extend({
  el: null,
  tagName: 'div',
  className: 'villain-block-wrapper',
  type: 'base',
  template: __WEBPACK_IMPORTED_MODULE_2_underscore___default.a.template('base'),
  resizeSetup: true,
  hasToolbar: false,
  store: 'main',

  wrapperTemplate: __WEBPACK_IMPORTED_MODULE_2_underscore___default.a.template(['<div class="villain-block-inner"><%= content %><%= actions %></div>'].join('\n')),

  actionsTemplate: __WEBPACK_IMPORTED_MODULE_2_underscore___default.a.template(['<div class="villain-actions">', '  <div class="villain-action-button villain-action-button-setup">', '    <i class="fa fa-wrench fa-fw"></i>', '  </div>', '  <div class="villain-action-button villain-action-button-del">', '    <i class="fa fa-close fa-fw"></i>', '  </div>', '  <div class="villain-action-button villain-action-button-move" draggable="true">', '    <i class="fa fa-arrows-alt fa-fw"></i>', '  </div>', '</div>'].join('\n')),

  setupTemplate: __WEBPACK_IMPORTED_MODULE_2_underscore___default.a.template('<div class="villain-setup-block" />'),
  ...
  events: function events() {
    return __WEBPACK_IMPORTED_MODULE_2_underscore___default.a.extend({}, this.originalEvents, this.additionalEvents);
  },
  ...
  destroy: function destroy() {
    ...
    this.remove();
    __WEBPACK_IMPORTED_MODULE_1_backbone___default.a.View.prototype.remove.call(this);
  },
  ...
  onPaste: function onPaste(e) {
    ...
    if (e && e.originalEvent.clipboardData && e.originalEvent.clipboardData.getData) {
      ...
      if (__WEBPACK_IMPORTED_MODULE_0_jquery___default.a.isArray(clipboardTypes)) {
  ...
  hasData: function hasData() {
    return this.data ? !__WEBPACK_IMPORTED_MODULE_2_underscore___default.a.isEmpty(this.data) : false;
  },
  ...
  refreshContentBlock: function refreshContentBlock() {
    ...
    this.$content.html(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(block).html());
  ...
  renderPlus: function renderPlus() {
    var addblock = new __WEBPACK_IMPORTED_MODULE_3__plus__["a" /* default */]({
      editor: this.editor,
      store: this.store
    });
    return addblock;
  ...
  afterShowSetupCallback: function afterShowSetupCallback() {},
  ...
  afterHideSetupCallback: function afterHideSetupCallback() {}
}, {
...
/* harmony default export */ exports["a"] = new Logger();
...
"use strict";
/* harmony export (immutable) */ exports["g"] = makeString;
/* harmony export (immutable) */ exports["d"] = copy;
/* harmony export (immutable) */ exports["b"] = setPath;
/* harmony export (immutable) */ exports["h"] = pushPath;
/* harmony export (immutable) */ exports["a"] = getPath;
/* harmony export (immutable) */ exports["c"] = deepExtend;
/* harmony export (immutable) */ exports["f"] = regexEscape;
/* harmony export (immutable) */ exports["e"] = escape;
...
var _defaultParams = __webpack_require__(32);
...
/* harmony default export */ exports["a"] = VillainError;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_backbone__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__errors_error__ = __webpack_require__(10);
...
var Plus = __WEBPACK_IMPORTED_MODULE_2_backbone___default.a.View.extend({
  el: null,
  tagName: 'div',
  className: 'villain-add-block villain-droppable',
  template: __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.template('<button class="villain-add-block-button">+</button>'),
  blockSelectionTemplate: __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.template('<div class="villain-block-selection"><%= content %><button class="villain-close-picker">×</button></div>'),
  events: {
  ...
  initialize: function initialize(options) {
    ...
    this.$el.attr('data-blockstore', this.store);
    this.$el.attr('id', __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.uniqueId('villain-plus-'));
    this.render();
  },
  render: function render() {
  ...
  onClickAddBlock: function onClickAddBlock(e) {
    ...
    var $addBlockButton = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(e.currentTarget);
    ...
    try {
      for (var _iterator = this.editor.blockRegistry.registry[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        if ({}.hasOwnProperty.call(cls, 'getButton')) {
          ...
          throw new __WEBPACK_IMPORTED_MODULE_3__errors_error__["a" /* default */]('No button found for ' + name);
        }
      }
    } catch (err) {
...
/* harmony default export */ exports["a"] = Plus;
...
var HTMLUtils = function () {
  ...
  _createClass(HTMLUtils, null, [{
    ...
    value: function createInput(labelName, inputName, initialValue, event) {
      var $input = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('\n      <div class="villain-form-input-wrapper">\n        <div class="villain-form-label-wrapper">\n          <label>' + labelName + '</label>\n        </div>\n        <input type="text" value="' + initialValue + '" name="' + inputName + '" />\n      </div>\n    ');
...
/* harmony default export */ exports["a"] = HTMLUtils;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_to_markdown__ = __webpack_require__(58);
...
var Markup = function () {
    ...
    _createClass(Markup, null, [{
        ...
        value: function toMD(html) {
            html = __WEBPACK_IMPORTED_MODULE_1_to_markdown___default()(html);
            html = html.replace(/&nbsp;/g, ' ');
        ...
        value: function toHTML(markdown, type) {
            // MD -> HTML
            if (__WEBPACK_IMPORTED_MODULE_0_underscore___default.a.isUndefined(markdown)) {
                return "";
            }

            type = __WEBPACK_IMPORTED_MODULE_0_underscore___default.a.classify(type);

            var html = markdown,
                shouldWrap = type === 'Text';

            if (__WEBPACK_IMPORTED_MODULE_0_underscore___default.a.isUndefined(shouldWrap)) {
                shouldWrap = false;
            }
            ...
            // with a slash.
            html = __WEBPACK_IMPORTED_MODULE_0_underscore___default.a.reverse(__WEBPACK_IMPORTED_MODULE_0_underscore___default.a.reverse(html).replace(/_(?!\\)((_\\|[^_])*)_(?=$|[^\\])/gm, function (match, p1) {
...
/* harmony default export */ exports["a"] = Markup;
...
/* unused harmony export alertPrompt */
/* harmony export (binding) */ __webpack_require__.d(exports, "a", function() { return alertError; });
/* unused harmony export alertInfo */
/* unused harmony export alertSuccess */
/* unused harmony export alertWarning */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_underscore__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_underscore___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_underscore__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_marked__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__block__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_markup__ = __webpack_require__(13);
...
var Blockquote = __WEBPACK_IMPORTED_MODULE_3__block__["a" /* default */].extend({
  type: 'blockquote',
  blockName: 'quote',
  blockIcon: 'fa-quote-right',
  template: __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.template('<div class="villain-quote-block villain-content"><blockquote contenteditable="true"><%= content %></blockquote><cite contenteditable="true"><%= cite %></cite></div>'),
  ...
  renderContentBlockHtml: function renderContentBlockHtml() {
    ...
    return this.template({
      content: __WEBPACK_IMPORTED_MODULE_4__utils_markup__["a" /* default */].toHTML(text),
      cite: this.data.cite
    });
  },
  ...
  getJSON: function getJSON() {
    ...
    var cite = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('cite', this.$content).html();
    var text = __WEBPACK_IMPORTED_MODULE_4__utils_markup__["a" /* default */].toMD(quote);
    var json = {
      type: this.type,
      data: {
        text: text,
  ...
  getHTML: function getHTML() {
    ...
    return __WEBPACK_IMPORTED_MODULE_2_marked___default.a.toHTML(textNode);
  }
});

/* harmony default export */ exports["a"] = Blockquote;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__block__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__plus__ = __webpack_require__(11);
/* Columns */
...
var Columns = __WEBPACK_IMPORTED_MODULE_2__block__["a" /* default */].extend({
  type: 'columns',
  blockName: 'cols',
  blockIcon: 'fa-columns',
  template: __WEBPACK_IMPORTED_MODULE_0_underscore___default.a.template('<div id="villain-column-row-<%= columnId %>" class="row"></div>'),
  columnTemplate: __WEBPACK_IMPORTED_MODULE_0_underscore___default.a.template('<div class="<%= columnClass %>"></div>'),
  ...
  createColumns: function createColumns($row, data, store) {
    for (var i = 0; i <= data.length - 1; i += 1) {
      ...
      var $column = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('<div class="' + columnClass + '"></div>');
      ...
      for (var j = 0; j < columnData.length; j += 1) {
        ...
        if (BlockClass !== false) {
          ...
          addblock = new __WEBPACK_IMPORTED_MODULE_3__plus__["a" /* default */]({
            store: store,
            editor: this.editor
          });
          $column.append(addblock.$el);
  ...
  parseColumns: function parseColumns(columns) {
    ...
    columns.each(function reduceColumns() {
      ...
      json.data.push({
        class: __WEBPACK_IMPORTED_MODULE_1_jquery___default()(this).attr('class'),
        data: blocksData
      });
    });
  ...
  parseBlocks: function parseBlocks(blocks) {
    ...
    __WEBPACK_IMPORTED_MODULE_1_jquery___default()(blocks).children('.villain-block-wrapper').each(function parseAndPushBlocks() {
  ...
  parseBlock: function parseBlock(block) {
    if (__WEBPACK_IMPORTED_MODULE_1_jquery___default()(block).attr('data-block-type') === 'columns') {
      var id = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(block).attr('data-block-id');
      var subCols = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('#villain-column-row-' + id, __WEBPACK_IMPORTED_MODULE_1_jquery___default()(block)).children();
      return this.parseColumns(subCols);
    }

    var blockStore = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(block).attr('data-blockstore');
    var blockId = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(block).attr('data-block-id');
  ...
  updateColumnCount: function updateColumnCount(e) {
    var self = this;
    var columnCount = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(e.target).val();
    this.$('.villain-column-widths').remove();
    var columnCountWrapper = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('<div class="villain-column-widths" />');
...
/* harmony default export */ exports["a"] = Columns;
...
var Divider = __WEBPACK_IMPORTED_MODULE_1__block__["a" /* default */].extend({
  type: 'divider',
  blockName: 'hr',
  blockIcon: 'fa-minus',
  template: __WEBPACK_IMPORTED_MODULE_0_underscore___default.a.template('<div class="villain-divider-block villain-content"><hr></div>'),
...
/* harmony default export */ exports["a"] = Divider;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__block__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__alerts__ = __webpack_require__(16);
...
var Gmap = __WEBPACK_IMPORTED_MODULE_2__block__["a" /* default */].extend({
  type: 'map',
  blockName: 'map',
  ...
  template: __WEBPACK_IMPORTED_MODULE_0_underscore___default.a.template('<div class="villain-map-block villain-content"><%= content %></div>'),
  ...
  buildString: function buildString(mapUrl) {
    ...
    __WEBPACK_IMPORTED_MODULE_0_underscore___default.a.each(this.providers, function loopProviders(provider, index) {
      match = provider.regex.exec(mapUrl);

      if (match !== null && !__WEBPACK_IMPORTED_MODULE_0_underscore___default.a.isUndefined(match[1])) {
        data = {
          source: index,
          embed_url: match[1]
        };
    ...
    if (!{}.hasOwnProperty.call(data, 'source')) {
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__alerts__["a" /* alertError */])('Feil format på embed.');
      return false;
    }
...
/* harmony default export */ exports["a"] = Gmap;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_marked___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_marked__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__block__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_html__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__utils_markup__ = __webpack_require__(13);
...
var Header = __WEBPACK_IMPORTED_MODULE_3__block__["a" /* default */].extend({
  type: 'header',
  blockName: 'h1-6',
  blockIcon: 'fa-header',
  template: __WEBPACK_IMPORTED_MODULE_0_underscore___default.a.template('\n    <div class="villain-text-block villain-text-block-header villain-content"\n         data-header-level="<%= level %>" contenteditable="true">\n    <%= content %>\n    </div>'),
  ...
  setup: function setup() {
    ...
    var headerSizeRadios = __WEBPACK_IMPORTED_MODULE_4__utils_html__["a" /* default */].createRadios(this.editor.i18n.t('header:header_size'), 'header-size-' + this.dataId, [{ name: 'H1', val: 1 }, { name: 'H2', val: 2 }, { name: 'H3', val: 3 }, { name: 'H4', val: 4 }, { name: 'H5', val: 5 }, { name: 'H6', val: 6 }], level, [{
      ev: 'change',
      fn: function fn(e) {
        _this.setDataProperty('level', parseInt(__WEBPACK_IMPORTED_MODULE_1_jquery___default()(e.target).val(), 10));
        _this.refreshContentBlock();
        _this.$content.attr('data-header-level', __WEBPACK_IMPORTED_MODULE_1_jquery___default()(e.target).val());
      }
    }]);

    var anchorInput = __WEBPACK_IMPORTED_MODULE_4__utils_html__["a" /* default */].createInput(this.editor.i18n.t('header:anchor'), 'header-anchor-' + this.dataId, anchor, {
      ev: 'keyup',
      fn: function fn(e) {
        _this.setDataProperty('anchor', __WEBPACK_IMPORTED_MODULE_1_jquery___default()(e.target).val());
      }
    });
  ...
  getData: function getData() {
    var data = this.data;
    data.text = __WEBPACK_IMPORTED_MODULE_5__utils_markup__["a" /* default */].toMD(this.getTextBlock().html()).trim();
    return data;
  },
  getJSON: function getJSON() {
    var data = this.getData();
  ...
  getHTML: function getHTML() {
    var textNode = this.getTextBlock().html();
    return '<h3>' + __WEBPACK_IMPORTED_MODULE_2_marked___default.a.toHTML(textNode) + '</h3>';
  }
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_underscore__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_underscore___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_underscore__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_autosize__ = __webpack_require__(15);
...
var Html = __WEBPACK_IMPORTED_MODULE_2__block__["a" /* default */].extend({
  type: 'html',
  blockName: 'html',
  blockIcon: 'fa-code',
  template: __WEBPACK_IMPORTED_MODULE_0_underscore___default.a.template('<div class="villain-html-block villain-content"><textarea><%= content %></textarea></div>'),
  ...
  afterRenderCallback: function afterRenderCallback() {
    ...
    __WEBPACK_IMPORTED_MODULE_1_autosize___default()(textarea);
    setTimeout(function () {
      return __WEBPACK_IMPORTED_MODULE_1_autosize___default.a.update(textarea);
    }, 1000);
  },
  renderEditorHtml: function renderEditorHtml() {
    var blockTemplate = this.renderContentBlockHtml();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__block__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_html__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__alerts__ = __webpack_require__(16);
...
var Image = __WEBPACK_IMPORTED_MODULE_2__block__["a" /* default */].extend({
  type: 'image',
  blockName: 'image',
  blockIcon: 'fa-file-image-o',
  template: __WEBPACK_IMPORTED_MODULE_0_underscore___default.a.template('<div class="villain-image-block villain-content"><img class="img-responsive" src="<%= url %>" /></div>'),
  ...
  onUploadClickAfterDrop: function onUploadClickAfterDrop(e) {
    ...
    __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.ajax({
      ...
      xhr: function xhr() {
        var customXhr = __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.ajaxSettings.xhr();
    ...
    }).done(__WEBPACK_IMPORTED_MODULE_1_jquery___default.a.proxy(function uploadCallback(retData) {
      var _this = this;
      ...
      if (retData.status === 200) {
        (function () {
          ...
          if ({}.hasOwnProperty.call(retData, 'image')) {
            ...
            var $image = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('<img src="' + imageData.src + '" />');
          ...
          if ({}.hasOwnProperty.call(retData, 'form')) {
            (function () {
              var inputsHtml = '';
              var inputTemplate = __WEBPACK_IMPORTED_MODULE_0_underscore___default.a.template(['<label><%= label %></label>', '<input type="<%= type %>" ', '       value="<%= value %>" ', '       name="<%= name %>"', '/>'].join('\n'));
              ...
              var formTemplate = __WEBPACK_IMPORTED_MODULE_0_underscore___default.a.template(['<form method="<%= method %>" ', '      action="<%= action %>" ', '      class="villain-form" ', '      name="<%= name %>"', '>', '<%= inputs %>', '</form>'].join('\n'));
              ...
              var $submitButton = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('<input type="submit" name="' + retData.form.name + '-submit" value="OK" />');
              ...
              $submitButton.on('click', function submitClicked(ev) {
                ...
                __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.ajax({
                  ...
                  processData: false,
                  dataType: 'json'
                }).done(__WEBPACK_IMPORTED_MODULE_1_jquery___default.a.proxy(function (attrsData) {
    ...
    }, this)).fail(__WEBPACK_IMPORTED_MODULE_1_jquery___default.a.proxy(function () {
      // Failed during upload.
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__alerts__["a" /* alertError */])(_this2.editor.i18n.t('errors:image_server_error'));
    }, this)).always(__WEBPACK_IMPORTED_MODULE_1_jquery___default.a.proxy(function () {}));
    return true;
  },
  ...
  onDropImage: function onDropImage(e) {
    ...
    if (/image/.test(file.type)) {
      ...
      this.$('.villain-image-dropper').html(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('<img>', {
  ...
  setup: function setup() {
    ...
    if (!this.hasData()) {
      ...
      var $imageDropper = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('\n        <div class="villain-image-dropper">\n          <i class="fa fa-image"></i>\n          <div>' + this.editor.i18n.t('images:pull_in_image_to_upload') + '</div>\n          <div><hr></div>\n          <div>\n            <button class="villain-image-browse-button">' + this.editor.i18n.t('images:browse_server_for_images') + '</button>\n          </div>\n        </div>\n      ');

      $imageDropper.find('.villain-image-browse-button').on('click', __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.proxy(this.onImageBrowseButton, this));
      ...
      (function () {
        ...
        var $form = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('<form name="image-meta-' + _this3.dataId + '">');

        var titleInput = __WEBPACK_IMPORTED_MODULE_3__utils_html__["a" /* default */].createInput(_this3.editor.i18n.t('images:title'), 'title', data.title, {
          ev: 'keyup',
          fn: __WEBPACK_IMPORTED_MODULE_0_underscore___default.a.debounce(function (e) {
            _this3.setDataProperty('title', __WEBPACK_IMPORTED_MODULE_1_jquery___default()(e.target).val());
          })
        });
        var creditsInput = __WEBPACK_IMPORTED_MODULE_3__utils_html__["a" /* default */].createInput(_this3.editor.i18n.t('images:credits'), 'credits', data.credits, {
          ev: 'keyup',
          fn: __WEBPACK_IMPORTED_MODULE_0_underscore___default.a.debounce(function (e) {
            _this3.setDataProperty('credits', __WEBPACK_IMPORTED_MODULE_1_jquery___default()(e.target).val());
          })
        });
        var URLInput = __WEBPACK_IMPORTED_MODULE_3__utils_html__["a" /* default */].createInput(_this3.editor.i18n.t('images:url'), 'link', data.link, {
          ev: 'keyup',
          fn: __WEBPACK_IMPORTED_MODULE_0_underscore___default.a.debounce(function (e) {
            _this3.setDataProperty('link', __WEBPACK_IMPORTED_MODULE_1_jquery___default()(e.target).val());
          })
        });
        ...
        var $radios = __WEBPACK_IMPORTED_MODULE_3__utils_html__["a" /* default */].createRadios(_this3.editor.i18n.t('images:size'), 'imagesize', sizes, data.url, [{
          ev: 'change',
          fn: function fn(e) {
            _this3.setUrl(__WEBPACK_IMPORTED_MODULE_1_jquery___default()(e.target).val());
          }
        }]);
  ...
  onImageBrowseButton: function onImageBrowseButton(e) {
    ...
    __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.ajax({
      ...
      processData: false,
      dataType: 'json'
    }).done(__WEBPACK_IMPORTED_MODULE_1_jquery___default.a.proxy(function (data) {
      /**
      ...
      var $images = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('<div />');

      for (var i = 0; i < data.images.length; i += 1) {
        var img = data.images[i];
        var $storeImg = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('<img src="' + img.thumb + '" />');
        $storeImg.data('sizes', img.sizes).data('large', img.src).data('title', img.title).data('credits', img.credits);
        $images.append($storeImg);
      }
      $images.on('click', 'img', __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.proxy(function setDataOnClick(ev) {
        this.setData({
          url: __WEBPACK_IMPORTED_MODULE_1_jquery___default()(ev.target).data('large'),
          title: __WEBPACK_IMPORTED_MODULE_1_jquery___default()(ev.target).data('title'),
          credits: __WEBPACK_IMPORTED_MODULE_1_jquery___default()(ev.target).data('credits'),
          sizes: __WEBPACK_IMPORTED_MODULE_1_jquery___default()(ev.target).data('sizes')
        });
        this.getData();
        this.refreshContentBlock();
        this.hideSetup();
      ...
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__alerts__["a" /* alertError */])(_this4.editor.i18n.t('errors:image_server_connection_failed'));
      _this4.done();
      return false;
    });
    return true;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_underscore__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_underscore___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_underscore__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_marked__ = __webpack_require__(6);
...
var List = __WEBPACK_IMPORTED_MODULE_2__block__["a" /* default */].extend({
  type: 'list',
  blockName: 'list',
  blockIcon: 'fa-list-ul',
  template: __WEBPACK_IMPORTED_MODULE_0_underscore___default.a.template(['<div class="villain-text-block villain-text-block-list villain-content" contenteditable="true">', '  <%= content %>', '</div>'].join('\n')),
  ...
  renderEditorHtml: function renderEditorHtml() {
    var blockTemplate = this.template({
      content: __WEBPACK_IMPORTED_MODULE_1_marked___default()(this.data.text)
    });
    var actionsTemplate = this.actionsTemplate();
    var wrapperTemplate = this.wrapperTemplate({
      content: blockTemplate,
  ...
  getHTML: function getHTML() {
    var textNode = this.getTextBlock().html();
    return '<h3>' + __WEBPACK_IMPORTED_MODULE_1_marked___default()(textNode) + '</h3>';
  },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_autosize__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_autosize___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_autosize__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_mixins__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_mixins___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__utils_mixins__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__block__ = __webpack_require__(2);
...
var Markdown = __WEBPACK_IMPORTED_MODULE_3__block__["a" /* default */].extend({
  type: 'markdown',
  blockName: 'markdown',
  blockIcon: 'fa-caret-square-o-down',
  template: __WEBPACK_IMPORTED_MODULE_0_underscore___default.a.template('<div class="villain-md-block villain-content"><textarea><%= content %></textarea></div>'),
...
/* harmony default export */ exports["a"] = Markdown;
...
var Slideshow = __WEBPACK_IMPORTED_MODULE_3__block__["a" /* default */].extend({
  type: 'slideshow',
  blockName: 'slides',
  blockIcon: 'fa-th',
  template: __WEBPACK_IMPORTED_MODULE_0_underscore___default.a.template(['<div class="villain-slideshow-block villain-content" contenteditable="false">', '  <h4>Slideshow</h4>', '  <%= content %>', '</div>'].join('\n')),
  ...
  renderDataImages: function renderDataImages() {
    var data = this.getData();
    if (__WEBPACK_IMPORTED_MODULE_0_underscore___default.a.isUndefined(data.images)) {
      return '';
    }
  ...
  getAllImageseries: function getAllImageseries() {
    ...
    __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.ajax({
      ...
      if (data.status === '200') {
        ...
        if (!__WEBPACK_IMPORTED_MODULE_0_underscore___default.a.isUndefined(self.data.imageseries)) {
    ...
    __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.ajax({
      ...
      if (data.status === '200') {
        (function () {
          ...
          if (!__WEBPACK_IMPORTED_MODULE_0_underscore___default.a.isUndefined(self.data.size)) {
            $sizeSelect.val(self.data.size).change();
            json.size = self.data.size;
          }

          $sizeSelect.on('change', function sizeSelectChangeCallback() {
            json.size = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(this).val();
            self.hideSetup();
          });
  ...
  setup: function setup() {
    ...
    if (!this.hasData()) {
      ...
      this.$setup.append(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('\n        <label for="imageserie">\n          ' + this.editor.i18n.t('slides:imageserie') + '\n        </label>\n        ' + select + '\n      '));

      var $select = this.$setup.find('.imageserie-select');
      $select.on('change', function imageSeriesSelectChangeCallback() {
        self.getImageseries(__WEBPACK_IMPORTED_MODULE_1_jquery___default()(this).val());
      });
  ...
  getHTML: function getHTML() {
    var textNode = this.getTextBlock().html();
    return '<h3>' + __WEBPACK_IMPORTED_MODULE_2_marked___default()(textNode) + '</h3>';
  }
});

/* harmony default export */ exports["a"] = Slideshow;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_html__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__utils_markup__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_trumbowyg__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_trumbowyg___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_trumbowyg__);
...
var Text = __WEBPACK_IMPORTED_MODULE_3__block__["a" /* default */].extend({
  hasToolbar: true,
  resizeSetup: false,
  type: 'text',
  blockName: 'text',
  blockIcon: 'fa-paragraph',
  template: __WEBPACK_IMPORTED_MODULE_0_underscore___default.a.template('<div class="villain-text-block villain-content" data-text-type="<%= type %>"><%= content %></div>'),

  initialize: function initialize(opts) {
    __WEBPACK_IMPORTED_MODULE_3__block__["a" /* default */].prototype.initialize.apply(this, [opts]);
  },
  renderEditorHtml: function renderEditorHtml() {
    var blockTemplate = this.renderContentBlockHtml();
    var actionsTemplate = this.actionsTemplate();
  ...
  renderContentBlockHtml: function renderContentBlockHtml() {
    var text = this.getTextBlockInner() ? this.getTextBlockInner() : this.data.text;
    return this.template({
      content: __WEBPACK_IMPORTED_MODULE_5__utils_markup__["a" /* default */].toHTML(text),
      type: this.data.type
    });
  },
  afterRenderCallback: function afterRenderCallback() {
    __WEBPACK_IMPORTED_MODULE_2_jquery___default.a.trumbowyg.svgPath = false;
    __WEBPACK_IMPORTED_MODULE_2_jquery___default()(this.$content).trumbowyg({
  ...
  getJSON: function getJSON() {
    var textNode = __WEBPACK_IMPORTED_MODULE_5__utils_markup__["a" /* default */].toMD(this.getTextBlockInner());
    var data = this.getData();
  ...
  getHTML: function getHTML() {
    var textNode = this.getTextBlock().html();
    return __WEBPACK_IMPORTED_MODULE_1_marked___default.a.toHTML(textNode);
  },
  afterShowSetupCallback: function afterShowSetupCallback() {
  ...
  setup: function setup() {
    ...
    var radios = __WEBPACK_IMPORTED_MODULE_4__utils_html__["a" /* default */].createRadios(this.editor.i18n.t('text:type'), 'text-type-' + this.dataId, [{ name: this.editor.i18n.t('text:paragraph'), val: 'paragraph' }, { name: this.editor.i18n.t('text:lead'), val: 'lead' }, { name: this.editor.i18n.t('text:custom'), val: 'custom' }], type, [{
      ev: 'change',
      fn: function fn(e) {
        var val = __WEBPACK_IMPORTED_MODULE_2_jquery___default()(e.target).val();
        if (val === 'custom') {
          __WEBPACK_IMPORTED_MODULE_2_jquery___default()('input[name="text-custom-' + _this.dataId + '"]').prop('disabled', false);
        } else {
          __WEBPACK_IMPORTED_MODULE_2_jquery___default()('input[name="text-custom-' + _this.dataId + '"]').prop('disabled', true);
        }
        _this.setDataProperty('type', val);
        _this.refreshContentBlock();
        _this.$content.attr('data-text-type', val);
      }
    }]);
    ...
    var $customField = __WEBPACK_IMPORTED_MODULE_4__utils_html__["a" /* default */].createInput(this.editor.i18n.t('text:custom'), 'text-custom-' + this.dataId, initialCustomClass, {
      ev: 'keyup',
      fn: function fn(e) {
        _this.setDataProperty('type', __WEBPACK_IMPORTED_MODULE_2_jquery___default()(e.target).val());
        _this.refreshContentBlock();
        _this.$content.attr('data-text-type', __WEBPACK_IMPORTED_MODULE_2_jquery___default()(e.target).val());
      }
    });
...
var Video = __WEBPACK_IMPORTED_MODULE_2__block__["a" /* default */].extend({
  type: 'video',
  blockName: 'video',
  ...
  template: __WEBPACK_IMPORTED_MODULE_0_underscore___default.a.template('<div class="villain-video-block villain-content"><%= content %></div>'),
  ...
  onVideoSetupClick: function onVideoSetupClick(e) {
    ...
    if (!__WEBPACK_IMPORTED_MODULE_0_underscore___default.a.isURI(videoUrl)) {
      return;
    }
  ...
  buildString: function buildString(videoUrl) {
    ...
    __WEBPACK_IMPORTED_MODULE_0_underscore___default.a.each(this.providers, function (provider, index) {
...
__WEBPACK_IMPORTED_MODULE_0_underscore___default.a.mixin({
    ...
    classify: function classify(str) {
        return __WEBPACK_IMPORTED_MODULE_0_underscore___default.a.titleize(String(str).replace(/[\W_]/g, ' ')).replace(/\s/g, '');
    },

    classifyList: function classifyList(a) {
        return __WEBPACK_IMPORTED_MODULE_0_underscore___default.a.map(a, function (i) {
            return __WEBPACK_IMPORTED_MODULE_0_underscore___default.a.classify(i);
        });
    },
    ...
    underscored: function underscored(str) {
        return __WEBPACK_IMPORTED_MODULE_0_underscore___default.a.trim(str).replace(/([a-z\d])([A-Z]+)/g, '$1_$2').replace(/[-\s]+/g, '_').toLowerCase();
    },
    ...
    flattern: function flattern(obj) {
        var x = {};
        __WEBPACK_IMPORTED_MODULE_0_underscore___default.a.each(obj, function (a, b) {
            x[__WEBPACK_IMPORTED_MODULE_0_underscore___default.a.isArray(obj) ? a : b] = true;
        });
        return x;
    },
...
__WEBPACK_IMPORTED_MODULE_1_jquery___default.a.fn.visible = function () {
    return this.css('visibility', 'visible');
};

__WEBPACK_IMPORTED_MODULE_1_jquery___default.a.fn.invisible = function () {
    return this.css('visibility', 'hidden');
};

__WEBPACK_IMPORTED_MODULE_1_jquery___default.a.fn.visibilityToggle = function () {
    return this.css('visibility', function (i, visibility) {
        return visibility == 'visible' ? 'hidden' : 'visible';
    });
};

__WEBPACK_IMPORTED_MODULE_1_jquery___default.a.fn.caretToEnd = function () {
    var range, selection;
...
__WEBPACK_IMPORTED_MODULE_1_jquery___default.a.fn.flash = function (duration, iterations) {
...
__WEBPACK_IMPORTED_MODULE_1_jquery___default.a.fn.shake = function (shakes, distance, duration) {
    shakes = shakes || 3;
    distance = distance || 10;
    duration = duration || 300;
    this.each(function () {
        __WEBPACK_IMPORTED_MODULE_1_jquery___default()(this).css('position', 'relative');
        for (var x = 1; x <= shakes; x++) {
            __WEBPACK_IMPORTED_MODULE_1_jquery___default()(this).animate({
                left: distance * -1
...
/* harmony export (immutable) */ exports["b"] = convertAPIOptions;
/* harmony export (immutable) */ exports["c"] = convertJSONOptions;
/* harmony export (immutable) */ exports["a"] = convertTOptions;
/* harmony export (immutable) */ exports["d"] = appendBackwardsAPI;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__editor__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__blocks_text__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__blocks_header__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__blocks_blockquote__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__blocks_list__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__blocks_image__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__blocks_slideshow__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__blocks_video__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__blocks_gmap__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__blocks_divider__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__blocks_html__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__blocks_markdown__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__blocks_columns__ = __webpack_require__(18);
/* harmony export (binding) */ __webpack_require__.d(exports, "Blocks", function() { return Blocks; });
'use strict';
...
var Blocks = {
  Text: __WEBPACK_IMPORTED_MODULE_1__blocks_text__["a" /* default */],
  Header: __WEBPACK_IMPORTED_MODULE_2__blocks_header__["a" /* default */],
  Blockquote: __WEBPACK_IMPORTED_MODULE_3__blocks_blockquote__["a" /* default */],
  List: __WEBPACK_IMPORTED_MODULE_4__blocks_list__["a" /* default */],
  Image: __WEBPACK_IMPORTED_MODULE_5__blocks_image__["a" /* default */],
  Slideshow: __WEBPACK_IMPORTED_MODULE_6__blocks_slideshow__["a" /* default */],
  Video: __WEBPACK_IMPORTED_MODULE_7__blocks_video__["a" /* default */],
  Gmap: __WEBPACK_IMPORTED_MODULE_8__blocks_gmap__["a" /* default */],
  Divider: __WEBPACK_IMPORTED_MODULE_9__blocks_divider__["a" /* default */],
  Html: __WEBPACK_IMPORTED_MODULE_10__blocks_html__["a" /* default */],
  Markdown: __WEBPACK_IMPORTED_MODULE_11__blocks_markdown__["a" /* default */],
  Columns: __WEBPACK_IMPORTED_MODULE_12__blocks_columns__["a" /* default */]
};

window.Villain = { Editor: __WEBPACK_IMPORTED_MODULE_0__editor__["a" /* default */], Blocks: Blocks };

/* harmony reexport (binding) */ __webpack_require__.d(exports, "Editor", function() { return __WEBPACK_IMPORTED_MODULE_0__editor__["a"]; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_backbone__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_backbone___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_backbone__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_uid__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_uid___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_uid__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_i18next__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__stores_store__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__stores_registry__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__plus__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__errors_error__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__locales_nb__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__locales_en__ = __webpack_require__(37);
...
var Editor = __WEBPACK_IMPORTED_MODULE_2_backbone___default.a.View.extend({
  ...
  initialize: function initialize(options) {
    ...
    this.instanceId = __WEBPACK_IMPORTED_MODULE_3_uid___default()();
    this.eventBus = __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.extend({}, __WEBPACK_IMPORTED_MODULE_2_backbone___default.a.Events);
    // create a blockstore
    this.blockStore = new __WEBPACK_IMPORTED_MODULE_5__stores_store__["a" /* default */]();
    this.blockStore.create('main');
    this.setOptions(options);

    this.i18n = __WEBPACK_IMPORTED_MODULE_4_i18next__["a" /* default */].init({
      lng: this.options.language,
      resources: {
        nb: __WEBPACK_IMPORTED_MODULE_9__locales_nb__["a" /* default */],
        en: __WEBPACK_IMPORTED_MODULE_10__locales_en__["a" /* default */]
      }
    });

    // initialize registry with optional extra blocks
    this.blockRegistry = new __WEBPACK_IMPORTED_MODULE_6__stores_registry__["a" /* default */](this, options.defaultBlocks || [], options.extraBlocks || []);
    this.browser = this.getBrowser();

    this.$textArea = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(options.textArea) || this.textArea;
    ...
    var $sourceView = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('\n      <div data-editor="' + this.instanceId + '"\n           class="villain-toggle-source">\n        <span class="">&#8734;</span>\n        <div class="villain-toggle-menu" style="display: none;">\n          Version: ' + this.version + '\n        </div>\n      </div>\n    ');

    $sourceView.on('click', 'span', __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.proxy(this.onToggleMask, this));
    $sourceView.insertBefore(this.$textArea);

    this.eventBus.on('source:toggle', this.toggleSource, this);

    var $v = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('<div class="villain-editor" data-villain-instance="' + this.instanceId + '"></div>');
  ...
  setOptions: function setOptions(options) {
    if (__WEBPACK_IMPORTED_MODULE_1_underscore___default.a.isUndefined(options.imageSeries) || __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.isUndefined(options.baseURL)) {
      throw new __WEBPACK_IMPORTED_MODULE_8__errors_error__["a" /* default */]('Villain: baseURL and imageSeries MUST be set on initialization.');
    }

    var newOpts = __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.extend(options, {
    ...
    this.options = __WEBPACK_IMPORTED_MODULE_1_underscore___default.a.extend(Editor.defaults, newOpts);
  },
  render: function render() {
    // add + block
    var addblock = new __WEBPACK_IMPORTED_MODULE_7__plus__["a" /* default */]({
      editor: this,
      store: 'main'
    });
    ...
    for (var i = 0; i <= this.data.length - 1; i += 1) {
      ...
      if (BlockClass !== false) {
        ...
        throw new __WEBPACK_IMPORTED_MODULE_8__errors_error__["a" /* default */]('Villain: No class found for type: ' + blockJson.type);
      }
    }
    return this;
  },
  onToggleMask: function onToggleMask() {
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.villain-toggle-source[data-editor="' + this.instanceId + '"] .villain-toggle-menu').toggle();
  ...
  organizeMode: function organizeMode() {
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.villain-block-wrapper').toggleClass('organize');
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.villain-block-wrapper[data-block-type="columns"]').removeClass('organize');
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.organize .villain-content').hide();
  },
  getJSON: function getJSON() {
    var self = this;
    var json = [];
    ...
    this.$('.villain-block-wrapper').each(function pushEachBlockWrapper() {
      ...
      var block = self.blockStore.getBlockById('main', __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).data('block-id'));
      if (block !== false) {
  ...
  onDragEnterDroppable: function onDragEnterDroppable(e) {
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.villain-add-block-button', e.currentTarget).addClass('drop-hover');
    e.preventDefault();
    e.stopPropagation();
  },
  onDragLeaveDroppable: function onDragLeaveDroppable(e) {
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.villain-add-block-button', e.currentTarget).removeClass('drop-hover');
    e.preventDefault();
    e.stopPropagation();
  },
  ...
  onDropDroppable: function onDropDroppable(e) {
    var target = e.currentTarget;
    if (__WEBPACK_IMPORTED_MODULE_0_jquery___default()(target).hasClass('villain-droppable') !== true) {
      e.preventDefault();
      e.stopPropagation();
      return false;
    }
    ...
    var $source = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('[data-block-id=' + sourceId + ']');
    var $sourceAdd = $source.next();

    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.villain-add-block-button', target).removeClass('drop-hover');
    ...
    $source.insertAfter(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(target));
    var oldBlockStore = $source.attr('data-blockstore');
    var newBlockStore = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(target).attr('data-blockstore');
  ...
  onDropTextblock: function onDropTextblock(e) {
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()(e.currentTarget).closest('.villain-block-wrapper').shake();
    e.preventDefault();
    e.stopPropagation();
    return false;
  },
  processPaste: function processPaste(pastedFrag) {
    ...
    if (pastedFrag.match(/(class="?Mso|style="[^"]*\bmso\-|w:WordDocument)/gi)) {
      ...
      cleanHtml = this.clean(__WEBPACK_IMPORTED_MODULE_0_jquery___default()('<div>').append(cleanHtml).html(), false, true);
  ...
  clean: function clean(html) {
    ...
    // Remove the class.
    var $div = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('<div>').append(cleanedHtml);
    $div.find('[class]:not([class^="fr-"])').each(function (index, el) {
      __WEBPACK_IMPORTED_MODULE_0_jquery___default()(el).removeAttr('class');
    });
  ...
  plainPasteClean: function plainPasteClean(html) {
    var $div = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('<div>').html(html);

    $div.find('h1, h2, h3, h4, h5, h6, pre, blockquote').each(function (i, el) {
      __WEBPACK_IMPORTED_MODULE_0_jquery___default()(el).replaceWith('<p>' + __WEBPACK_IMPORTED_MODULE_0_jquery___default()(el).html() + '</p>');
    });

    var replacePlain = function replacePlain(i, el) {
      __WEBPACK_IMPORTED_MODULE_0_jquery___default()(el).replaceWith(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(el).html());
    };
  ...
  removeEmptyTags: function removeEmptyTags(html) {
    ...
    while (emptyTags.length) {
      for (var i = 0; i < emptyTags.length; i += 1) {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()(emptyTags[i]).remove();
      }
    ...
    $div.find('> div').each(function (i, div) {
      __WEBPACK_IMPORTED_MODULE_0_jquery___default()(div).replaceWith(__WEBPACK_IMPORTED_MODULE_0_jquery___default()(div).html() + '<br />');
    });
    ...
    while (divs.length) {
      for (var _i = 0; _i < divs.length; _i += 1) {
        var $el = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(divs[_i]);
...
/* harmony default export */ exports["a"] = LOCALE_EN;
...
/* harmony default export */ exports["a"] = LOCALE_NB;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_underscore__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_underscore___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_underscore__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_mixins__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_mixins___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__utils_mixins__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__errors_error__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__blocks_text__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__blocks_header__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__blocks_blockquote__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__blocks_list__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__blocks_image__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__blocks_slideshow__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__blocks_video__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__blocks_gmap__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__blocks_divider__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__blocks_html__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__blocks_markdown__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__blocks_columns__ = __webpack_require__(18);
'use strict';
...
var DEFAULT_BLOCKS = [{
  name: 'Text',
  cls: __WEBPACK_IMPORTED_MODULE_3__blocks_text__["a" /* default */]
}, {
  name: 'Header',
  cls: __WEBPACK_IMPORTED_MODULE_4__blocks_header__["a" /* default */]
}, {
  name: 'Blockquote',
  cls: __WEBPACK_IMPORTED_MODULE_5__blocks_blockquote__["a" /* default */]
}, {
  name: 'List',
  cls: __WEBPACK_IMPORTED_MODULE_6__blocks_list__["a" /* default */]
}, {
  name: 'Image',
  cls: __WEBPACK_IMPORTED_MODULE_7__blocks_image__["a" /* default */]
}, {
  name: 'Slideshow',
  cls: __WEBPACK_IMPORTED_MODULE_8__blocks_slideshow__["a" /* default */]
}, {
  name: 'Video',
  cls: __WEBPACK_IMPORTED_MODULE_9__blocks_video__["a" /* default */]
}, {
  name: 'Map',
  cls: __WEBPACK_IMPORTED_MODULE_10__blocks_gmap__["a" /* default */]
}, {
  name: 'Divider',
  cls: __WEBPACK_IMPORTED_MODULE_11__blocks_divider__["a" /* default */]
}, {
  name: 'Html',
  cls: __WEBPACK_IMPORTED_MODULE_12__blocks_html__["a" /* default */]
}, {
  name: 'Markdown',
  cls: __WEBPACK_IMPORTED_MODULE_13__blocks_markdown__["a" /* default */]
}, {
  name: 'Columns',
  cls: __WEBPACK_IMPORTED_MODULE_14__blocks_columns__["a" /* default */]
}];
  ...
  _createClass(BlockRegistry, [{
    ...
    value: function checkBlocks() {
      for (var i = 0; i < this.registry.length; i += 1) {
        ...
        if (__WEBPACK_IMPORTED_MODULE_0_underscore___default.a.isUndefined(b.cls)) {
          throw new __WEBPACK_IMPORTED_MODULE_2__errors_error__["a" /* default */]('Villain: Missing block source for ' + b.name + '! Please ensure it is included.');
        }
      }
    }
  }, {
    ...
    value: function getBlockClassByType(type) {
      var b = __WEBPACK_IMPORTED_MODULE_0_underscore___default.a.find(this.registry, { name: __WEBPACK_IMPORTED_MODULE_0_underscore___default()(type).capitalize() });
      if (b) {
        return b.cls;
      }
...
/* harmony default export */ exports["a"] = BlockRegistry;
...
var BlockStore = function () {
  ...
  _createClass(BlockStore, [{
    ...
    value: function del(store, id) {
      this.stores[store] = __WEBPACK_IMPORTED_MODULE_0_underscore___default.a.filter(this.stores[store], function (block) {
...
/* harmony default export */ exports["a"] = BlockStore;
...
var blockElements = {};
__webpack_require__(41).forEach(function (name) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__EventEmitter__ = __webpack_require__(4);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var Connector = function (_EventEmitter) {
  ...
  Connector.prototype.loaded = function loaded(name, err, data) {
    ...
    this.queue.forEach(function (q) {
      __WEBPACK_IMPORTED_MODULE_0__utils__["h" /* pushPath */](q.loaded, [lng], ns);
    ...
    if (options.allowMultiLoading && this.backend.readMulti) {
      this.read(toLoad.toLoadLanguages, toLoad.toLoadNamespaces, 'readMulti', null, null, function (err, data) {
        ...
        toLoad.toLoad.forEach(function (name) {
          ...
          var bundle = __WEBPACK_IMPORTED_MODULE_0__utils__["a" /* getPath */](data, [l, n]);
          if (bundle) {
...
var Interpolator = function () {
  ...
  Interpolator.prototype.init = function init() {
    ...
    if (reset) {
      ...
      this.escape = options.interpolation && options.interpolation.escape || __WEBPACK_IMPORTED_MODULE_0__utils__["e" /* escape */];
    }
    ...
    this.prefix = iOpts.prefix ? __WEBPACK_IMPORTED_MODULE_0__utils__["f" /* regexEscape */](iOpts.prefix) : iOpts.prefixEscaped || '{{';
    this.suffix = iOpts.suffix ? __WEBPACK_IMPORTED_MODULE_0__utils__["f" /* regexEscape */](iOpts.suffix) : iOpts.suffixEscaped || '}}';
    this.formatSeparator = iOpts.formatSeparator ? __WEBPACK_IMPORTED_MODULE_0__utils__["f" /* regexEscape */](iOpts.formatSeparator) : iOpts.formatSeparator || ',';

    this.unescapePrefix = iOpts.unescapeSuffix ? '' : iOpts.unescapePrefix || '-';
    this.unescapeSuffix = this.unescapePrefix ? '' : iOpts.unescapeSuffix || '';

    this.nestingPrefix = iOpts.nestingPrefix ? __WEBPACK_IMPORTED_MODULE_0__utils__["f" /* regexEscape */](iOpts.nestingPrefix) : iOpts.nestingPrefixEscaped || __WEBPACK_IMPORTED_MODULE_0__utils__["f" /* regexEscape */]('$t(');
    this.nestingSuffix = iOpts.nestingSuffix ? __WEBPACK_IMPORTED_MODULE_0__utils__["f" /* regexEscape */](iOpts.nestingSuffix) : iOpts.nestingSuffixEscaped || __WEBPACK_IMPORTED_MODULE_0__utils__["f" /* regexEscape */](')');
  ...
  Interpolator.prototype.interpolate = function interpolate(str, data, lng) {
    ...
    var handleFormat = function handleFormat(key) {
      if (key.indexOf(_this.formatSeparator) < 0) return __WEBPACK_IMPORTED_MODULE_0__utils__["a" /* getPath */](data, key);

      var p = key.split(_this.formatSeparator);
      var k = p.shift().trim();
      var f = p.join(_this.formatSeparator).trim();

      return _this.format(__WEBPACK_IMPORTED_MODULE_0__utils__["a" /* getPath */](data, k), f, lng);
    };
    ...
    while (match = this.regexp.exec(str)) {
      ...
      if (typeof value !== 'string') value = __WEBPACK_IMPORTED_MODULE_0__utils__["g" /* makeString */](value);
      if (!value) {
  ...
  Interpolator.prototype.nest = function nest(str, fc) {
    ...
    while (match = this.nestingRegexp.exec(str)) {
      ...
      value = this.escapeValue ? regexSafe(__WEBPACK_IMPORTED_MODULE_0__utils__["e" /* escape */](value)) : regexSafe(value);
      str = str.replace(match[0], value);
      this.regexp.lastIndex = 0;
    }
    return str;
...
/* harmony default export */ exports["a"] = Interpolator;
...
/* harmony default export */ exports["a"] = LanguageUtil;
...
/* harmony default export */ exports["a"] = PluralResolver;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__EventEmitter__ = __webpack_require__(4);
...
var ResourceStore = function (_EventEmitter) {
  ...
  ResourceStore.prototype.getResource = function getResource(lng, ns, key) {
    ...
    return __WEBPACK_IMPORTED_MODULE_1__utils__["a" /* getPath */](this.data, path);
  };
  ...
  ResourceStore.prototype.addResource = function addResource(lng, ns, key, value) {
    ...
    __WEBPACK_IMPORTED_MODULE_1__utils__["b" /* setPath */](this.data, path, value);
  ...
  ResourceStore.prototype.addResourceBundle = function addResourceBundle(lng, ns, resources, deep, overwrite) {
    ...
    var pack = __WEBPACK_IMPORTED_MODULE_1__utils__["a" /* getPath */](this.data, path) || {};

    if (deep) {
      __WEBPACK_IMPORTED_MODULE_1__utils__["c" /* deepExtend */](pack, resources, overwrite);
    } else {
      pack = _extends({}, pack, resources);
    }

    __WEBPACK_IMPORTED_MODULE_1__utils__["b" /* setPath */](this.data, path, pack);
...
/* harmony default export */ exports["a"] = ResourceStore;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__logger__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__EventEmitter__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__postProcessor__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__compatibility_v1__ = __webpack_require__(30);
...
var Translator = function (_EventEmitter) {
  ...
  function Translator(services) {
    ...
    __WEBPACK_IMPORTED_MODULE_4__utils__["d" /* copy */](['resourceStore', 'languageUtils', 'pluralResolver', 'interpolator', 'backendConnector'], services, _this);
  ...
  Translator.prototype.exists = function exists(key) {
    ...
    if (this.options.compatibilityAPI === 'v1') {
      options = __WEBPACK_IMPORTED_MODULE_3__compatibility_v1__["a" /* convertTOptions */](options);
    }
...
/* harmony default export */ exports["a"] = Translator;
...
"use strict";
/* harmony export (immutable) */ exports["b"] = get;
/* harmony export (immutable) */ exports["a"] = transformOptions;
function get() {
  return {
    debug: false,
    initImmediate: true,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__logger__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__EventEmitter__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ResourceStore__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Translator__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__LanguageUtils__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__PluralResolver__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Interpolator__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__BackendConnector__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__CacheConnector__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__defaults__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__postProcessor__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__compatibility_v1__ = __webpack_require__(30);
var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; };
...
var I18n = function (_EventEmitter) {
  ...
  I18n.prototype.init = function init(options, callback) {
    ...
    if (options.compatibilityAPI === 'v1') {
      this.options = _extends({}, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_9__defaults__["b" /* get */])(), __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_9__defaults__["a" /* transformOptions */])(__WEBPACK_IMPORTED_MODULE_11__compatibility_v1__["b" /* convertAPIOptions */](options)), {});
    } else if (options.compatibilityJSON === 'v1') {
      this.options = _extends({}, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_9__defaults__["b" /* get */])(), __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_9__defaults__["a" /* transformOptions */])(__WEBPACK_IMPORTED_MODULE_11__compatibility_v1__["c" /* convertJSONOptions */](options)), {});
    } else {
    ...
    if (this.options.compatibilityAPI === 'v1') __WEBPACK_IMPORTED_MODULE_11__compatibility_v1__["d" /* appendBackwardsAPI */](this);
...
/* harmony default export */ exports["a"] = new I18n();
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__i18next__ = __webpack_require__(51);


/* harmony default export */ exports["a"] = __WEBPACK_IMPORTED_MODULE_0__i18next__["a" /* default */];
...
var toMarkdown
var converters
var mdConverters = __webpack_require__(61)
var gfmConverters = __webpack_require__(59)
var HtmlParser = __webpack_require__(60)
...
function createHtmlParser () {
  ...
  if (typeof document === 'undefined') {
    var jsdom = __webpack_require__(65)
