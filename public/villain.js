...
function alertError(text) {
  (0, _sweetalert2.default)({
    text: text, type: 'error', title: 'Feil'
  });
}

function alertInfo(text) {
  (0, _sweetalert2.default)({
    text: text, type: 'info', title: 'Info'
  });
}

function alertSuccess(text) {
  (0, _sweetalert2.default)({
    text: text, type: 'success', title: 'Suksess'
  });
}

function alertWarning(text) {
  (0, _sweetalert2.default)({
    text: text, type: 'warning', title: 'Advarsel'
  });
}
...
var Image = _block2.default.extend({
    ...
    _jquery2.default.ajax({
      ...
      if (retData.status === '200') {
        (function () {
          ...
          _this.$setup.append('<div class="villain-message success">Bildet er lastet opp</div>');
          ...
          if ({}.hasOwnProperty.call(retData, 'form')) {
            (function () {
              ...
              var $submitButton = (0, _jquery2.default)('<input type="submit" name="' + retData.form.name + '-submit" value="Lagre" />');
      ...
      (0, _alerts.alertError)('Feil fra server under opplasting.');
  ...
  setup: function setup() {
    ...
    if (!this.hasData()) {
      ...
      var $imageDropper = (0, _jquery2.default)(['<div class="villain-image-dropper">', '  <i class="fa fa-image"></i>', '  <div>Dra bildet du vil laste opp hit</div>', '  <div><hr></div>', '  <div>', '    <button class="villain-image-browse-button">Hent bilde fra server</button>', '  </div>', '</div>'].join('\n'));
      ...
      this.clearSetup();
      var data = this.getData();
      var $form = (0, _jquery2.default)('<form name="image-meta-' + this.dataId + '">');
      ...
      this.$setup.find('input[name="title"]').on('keyup', _underscore2.default.debounce(_jquery2.default.proxy(function setTitle(e) {
        this.setDataProperty('title', (0, _jquery2.default)(e.target).val());
      }, this), 700, false));
      this.$setup.find('input[name="credits"]').on('keyup', _underscore2.default.debounce(_jquery2.default.proxy(function setCredits(e) {
        this.setDataProperty('credits', (0, _jquery2.default)(e.target).val());
      }, this), 700, false));
      this.$setup.find('input[name="link"]').on('keyup', _underscore2.default.debounce(_jquery2.default.proxy(function setLink(e) {
        this.setDataProperty('link', (0, _jquery2.default)(e.target).val());
      }, this), 700, false));
      this.$setup.find('input[type=radio]').on('change', _jquery2.default.proxy(function setUrl(e) {
  ...
  onImageBrowseButton: function onImageBrowseButton(e) {
    ...
    _jquery2.default.ajax({
       ...
       */
      if (data.status !== 200) {
        (0, _alerts.alertError)('Ingen bilder fantes.');
        _this2.done();
        return false;
      }
      ...
      _this2.$setup.html('');
      _this2.$setup.append('<div class="villain-message success">Klikk på bildet du vil sette inn</div>');
      _this2.$setup.append($images);
      _this2.done();
      return true;
    }, this)).fail(function () {
      (0, _alerts.alertError)('Kunne ikke koble til bildeserver.');
      _this2.done();
      return false;
    });
    return true;
  ...
  setup: function setup() {
    ...
    if (!this.hasData()) {
      (function () {
        ...
        _this.$setup.append((0, _jquery2.default)('<label for="imageserie">Bildeserie</label>' + select));
      ...
      this.$setup.append((0, _jquery2.default)('<label for="imageserie">Bildeserie</label>' + _select));
...
var Editor = _backbone2.default.View.extend({
  ...
  setOptions: function setOptions(options) {
    ...
    this.options = _underscore2.default.extend({}, newOpts); // FIXME: might be $.extend!
  },
  render: function render() {
    // add + block
    var addblock = new _plus2.default({
